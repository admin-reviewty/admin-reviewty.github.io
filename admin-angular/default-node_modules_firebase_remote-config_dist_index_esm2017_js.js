...
/* harmony export */ });
/* harmony import */ var _Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ 19369);
...
function _getErrorFromResponse() {
  _getErrorFromResponse = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (requestName, response) {
...
function _retryIfServerError() {
  _retryIfServerError = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (fn) {
...
function _createInstallationRequest() {
  _createInstallationRequest = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig, {
    fid
  }) {
...
function _set() {
  _set = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig, value) {
    const key = getKey(appConfig);
...
function _remove() {
  _remove = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig) {
    const key = getKey(appConfig);
    const db = yield getDbPromise();
    const tx = db.transaction(OBJECT_STORE_NAME, 'readwrite');
...
function _update() {
  _update = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig, updateFn) {
    const key = getKey(appConfig);
    const db = yield getDbPromise();
    const tx = db.transaction(OBJECT_STORE_NAME, 'readwrite');
...
function _getInstallationEntry() {
  _getInstallationEntry = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig) {
...
function _registerInstallation() {
  _registerInstallation = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig, installationEntry) {
    try {
...
function _waitUntilFidRegistration() {
  _waitUntilFidRegistration = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig) {
...
function _generateAuthTokenRequest() {
  _generateAuthTokenRequest = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* ({
    appConfig,
...
function _refreshAuthToken() {
  _refreshAuthToken = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (installations, forceRefresh = false) {
    let tokenPromise;
...
function _waitUntilAuthTokenRequest() {
  _waitUntilAuthTokenRequest = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (installations, forceRefresh) {
    // Unfortunately, there is no way of reliably observing when a value in
    // IndexedDB changes (yet, see https://github.com/WICG/indexed-db-observers),
    // so we need to poll.
...
function _fetchAuthTokenFromServer() {
  _fetchAuthTokenFromServer = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (installations, installationEntry) {
    try {
...
function _getId() {
  _getId = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (installations) {
...
function _getToken() {
  _getToken = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (installations, forceRefresh = false) {
    const installationsImpl = installations;
...
function _completeInstallationRegistration() {
  _completeInstallationRegistration = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig) {
    const {
      registrationPromise
    } = yield getInstallationEntry(appConfig);
...
function _deleteInstallationRequest() {
  _deleteInstallationRequest = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (appConfig, installationEntry) {
...
function _deleteInstallations() {
  _deleteInstallations = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (installations) {
    const {
      appConfig
    } = installations;
...
function _activate() {
  _activate = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (remoteConfig) {
...
function _fetchConfig() {
  _fetchConfig = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (remoteConfig) {
    ...
    setTimeout( /*#__PURE__*/(0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
...
class CachingClient {
  ...
  fetch(request) {
    ...
    return (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
...
function _fetchAndActivate() {
  _fetchAndActivate = (0,_Volumes_data_WORK_REV_rev_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (remoteConfig) {
